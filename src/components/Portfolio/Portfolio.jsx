...
export default function Portfolio() {
  ...
  return (
    ...
    >
      ...
      <div
        className="preview-img d-flex justify-content-center align-items-center position-fixed top-0 start-0 w-100 vh-100 d-none"
        style={{ backgroundColor: "rgba(26, 188, 156, 0.9)" }}
        onClick={closeImg}
      >
        <img id="img-preview" alt="preview img" className="w-50 mt-5 rounded-3" />
      </div>
    </section>
  );
}
